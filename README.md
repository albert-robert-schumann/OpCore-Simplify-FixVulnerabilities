...
<p> This project uses <a href="https://docs.github.com/en/code-security/dependabot">Dependabot</a> to automatically check for and update vulnerable dependencies.</p>
