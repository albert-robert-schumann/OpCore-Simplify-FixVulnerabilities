...
<p> WiFi passwords in wifi_extractor.py were stored in plain text. This is mitigated by changing line 345 to print("{:<6} {:<32} {:<8}".format(index, ssid[:31] + "..." if len(ssid) > 31 else ssid, "******")).</p>
<p> Other changes:</p>
